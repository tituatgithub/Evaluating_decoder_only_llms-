...
OUTPUT_PATH = "/home/ethicaldevice/Desktop/Titu_exp/llama_output_en/llama_translations_hin_ro_en.json"
RESULTS_PATH = "/home/ethicaldevice/Desktop/Titu_exp/llama_output_en/eval_results_hin_ro_en.json"
...
df = pd.merge(df_gold, df_pred[["Id", "llama_translation_hin_ro_en"]], on="Id", how="inner")
...
for _, row in df.iterrows():
    pred = row["llama_translation_hin_ro_en"]
...
# Compute BERTScore
# ----------------------------
# Use only the first reference per example for BERTScore (as it's single-ref)
