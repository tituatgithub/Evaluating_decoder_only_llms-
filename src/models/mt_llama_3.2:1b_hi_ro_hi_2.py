...
OUTPUT_PATH = "/home/ethicaldevice/Desktop/Titu_exp/llama_output_hi/llama_translations_hi_hin_ro.json"
RESULTS_PATH = "/home/ethicaldevice/Desktop/Titu_exp/llama_output_hi/eval_results_hi_hin_ro.json"
...
df = pd.merge(df_gold, df_pred[["Id", "llama_translation_hi_hin_ro"]], on="Id", how="inner")

print(f"Loaded {len(df)} Hindi (Romanized) examples for evaluation.")
...
for _, row in df.iterrows():
    pred = row["llama_translation_hi_hin_ro"]
...
print("✅ Hindi (Romanized) evaluation finished.")
