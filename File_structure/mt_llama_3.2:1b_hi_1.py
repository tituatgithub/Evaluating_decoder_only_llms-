...
PROGRESS_PATH = os.path.join(OUTPUT_DIR, "progress_hi.json")
CHECKPOINT_PATH = os.path.join(OUTPUT_DIR, "llama_checkpoint_hi.json")
LIVE_STATUS_PATH = os.path.join(OUTPUT_DIR, "live_status_hi.json")
FINAL_OUTPUT_PATH = os.path.join(OUTPUT_DIR, "llama_translations_hi.json")
